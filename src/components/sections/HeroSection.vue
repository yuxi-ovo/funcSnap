<template>
  <section 
    class="hero-section relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-24 pb-12 overflow-hidden"
    ...
    <div class="relative z-10 max-w-7xl mx-auto w-full mt-20">
      ...
      <div class="space-y-12 lg:space-y-16">
        ...
        <div class="text-center space-y-6 max-w-4xl mx-auto">
          ...
          >
            {{ t('hero.title') }}
            <span class="block text-transparent bg-clip-text bg-gradient-to-r 
                         from-blue-600 via-purple-600 to-blue-600 
                         dark:from-blue-400 dark:via-purple-400 dark:to-blue-400
                         mt-2 animate-gradient">
          ...
          <p 
            ...
            class="font-body text-lg sm:text-xl text-slate-600 dark:text-slate-400
          ...
          <div 
            ...
            class="flex flex-wrap gap-4 pt-4 justify-center"
          >
            <button 
              class="group relative bg-gradient-to-r from-blue-600 to-blue-700 
            ...
            <button 
              class="group relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm
        ...
        <div 
          ...
          class="grid lg:grid-cols-2 gap-6 lg:gap-8 items-stretch"
        >
          <!-- Left: Code Preview -->
          <div class="space-y-3 flex flex-col group">
            <div class="flex items-center gap-2 px-1">
              <div class="w-2 h-2 rounded-full bg-slate-400 dark:bg-slate-600 
          ...
          <div class="space-y-3 flex flex-col group">
            ...
            <div class="flex-1 flex flex-col">
              <div class="relative rounded-lg overflow-hidden shadow-2xl 
                          ...
                          hover:scale-[1.02] hover:shadow-blue-500/20 hover:shadow-2xl
                          group-hover:border-blue-500/50">
                <!-- Glow effect on hover -->
                <div class="absolute inset-0 bg-gradient-to-r from-blue-500/0 via-blue-500/10 to-purple-500/0 
