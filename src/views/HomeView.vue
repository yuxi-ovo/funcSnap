	...
	<div class="home bg-white dark:bg-slate-900 transition-colors duration-300">
		...
		<section id="install" class="py-24 px-4 bg-slate-50 dark:bg-slate-800" aria-labelledby="install-heading">
			<div class="max-w-4xl mx-auto text-center">
				...
				<button
					class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer focus:outline-none focus:ring-4 focus:ring-blue-500/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-800"
